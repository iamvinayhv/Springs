...
public class WorldServiceImpl implements WorldService {
	...
	static {
		...
		countries.put(48,   new Country(48,   "Ghana",        92098,    23837000L,  parseDate("29-mar-2015"),   "Cedi"));
		countries.put(53,   new Country(53,   "Australia",    2966200,  21884000L,  parseDate("04-sep-2009"),   "Australian Dollar"));
		countries.put(73,   new Country(73,   "Greece",       50949,    11257285L,  parseDate("01-jan-2009"),	"Euro"));
		countries.put(122,  new Country(122,  "Georgia",      26900,    4382100L,   parseDate("01-jan-2009"),	"Lari"));
		countries.put(123,  new Country(123,  "New Zealand",  104454,   4320300L,   parseDate("04-sep-2009"),	"New Zealand Dollar"));
		countries.put(147,  new Country(147,  "Gambia",       4361,     1705000L,   parseDate("08-dec-2007"),	"Dalasi"));
		countries.put(149,  new Country(149,  "Gabon",        103347,   1475000L,   parseDate("03-jan-2005"),	"CFA franc"));
		}
	...
	private static Date parseDate(String textDate) {
		...
		try {
			...
			d= new SimpleDateFormat("dd-MMM-yyyy").parse(textDate);
		} 
